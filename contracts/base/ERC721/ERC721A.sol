...
contract ERC721A is IERC721A {
    ...
    function _checkContractOnERC721Received(
        ...
        try IERC721AReceiver(to).onERC721Received(_msgSenderERC721A(), from, tokenId, _data) returns (bytes4 retval) {
            return retval == IERC721AReceiver(to).onERC721Received.selector;
